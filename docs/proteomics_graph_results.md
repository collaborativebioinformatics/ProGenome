...
PyGCN 1 was the original two-layer GCN using a 2,000-edge protein projection.
PyGCN 2 used the complete 30,354-edge undirected projection, GATv2 attention,
weight and lift edge attributes, three-way hyperparameter tuning, and longer
training with early stopping. PyGCN 1 achieved held-out ROC AUC 0.512 and
five-fold ROC AUC 0.496 ± 0.018; PyGCN 2 achieved held-out ROC AUC 0.517 and
five-fold ROC AUC 0.535 ± 0.026. Logistic regression remained much stronger,
with held-out ROC AUC 0.933 and five-fold ROC AUC 0.930 ± 0.011. Thus, the
additional graph capacity produced a modest improvement over PyGCN 1 but did
not yet translate into useful phenotype discrimination on this dataset.
