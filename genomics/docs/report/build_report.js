...
const CONTENT = [
  ...
  t(["Retrieved fact for HG00103", "Value"], [
    ["GNN prediction", "control (truth: control)"],
    ["globally salient clusters carried", "chr22_46902935-46974137_cluster186 (0.110), chr22_46974137-47051453_cluster43 (0.055), chr22_40032702-40132216_cluster25 (0.046)"],
  ...
  t(["Decoder field", "Text returned (Nemotron 3 Super, 13.3 s, 25 ids cited, 0 unknown)"], [
    ...
    ["genome_proteome_links", "cluster151 -> block 40032702-40132216 -> TNRC6B -> Q9UPQ9 (carried, enriched in EAS); cluster545 -> RBFOX2 -> O43251; cluster35 -> MYO18B -> Q8IUG5 (enriched in EUR)"],
  ...
  t(["Site (held-out n)", "Alone, 150 steps", "Federated, 150 steps", "Alone, 50 steps", "Federated, 50 steps"], [
  ...
  p("AUC / balanced accuracy on each site's own held-out people. Transfer of a lone model to other sites' people (150 steps, AUC): the SITE1 model scores 0.982 on SITE2 people and 0.949 on SITE3 people; SITE2: 0.993 and 0.969; SITE3: 0.997 and 0.998; the federated model 0.999 / 1.000 / 0.968 on the three sites."),
