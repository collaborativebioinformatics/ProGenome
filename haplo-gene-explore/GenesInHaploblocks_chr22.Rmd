---
title: "Haploblocks and Genes within them"
author: "Friederike Duendar"
date: "2026-09-17"
knit: (function(inputFile, encoding) {out_dir <- "../docs"; rmarkdown::render(inputFile,encoding=encoding, output_dir=file.path(dirname(inputFile), out_dir))})
output:
  github_document:
    toc: yes
    toc_depth: 5
...
---
```{r setup_justLeaveAsIs, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)
knitr::opts_knit$set(root.dir = getwd()) 
knitr::opts_knit$set(base.dir = "../docs/") # The directory in which the plots are placed; this is *relative* to where your .Rmd file is
knitr::opts_chunk$set(fig.path = "plots/") # make this a less generic name, e.g. "plots_script1/"
```
...
I'm just going to use the edge information to derive the genomic regions of the haploblocks represented with edges in the co-occurrence graph
...
Each row now represents one haploblock on chromosome 22 that is part of the co-occurrence graph
...
Gene coordinates were downloaded from the UCSC Browser
